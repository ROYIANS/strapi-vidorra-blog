...
export function BackgroundDecoration() {
    return (
        <>
            ...
            <div className="hidden dark:block absolute w-full h-full inset-0 overflow-hidden pointer-events-none">
                {/* Top right geometric */}
                <svg className="absolute top-0 right-0" width="219" height="147" viewBox="0 0 219 147" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* Bottom left circle */}
                <svg className="absolute bottom-0 left-0" width="232" height="191" viewBox="0 0 232 191" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* Jumbo effect */}
                <div className="jumbo absolute inset-0 opacity-5" />
            </div>

            {/* Light mode grid background */}
            <div className="block dark:hidden absolute w-full h-full inset-0 overflow-hidden pointer-events-none">
