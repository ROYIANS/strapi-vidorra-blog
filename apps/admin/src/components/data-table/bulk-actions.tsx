...
export function DataTableBulkActions<TData>({
  ...
  useEffect(() => {
    if (selectedCount > 0) {
      const message = t('dataTable.bulkActions.availableAnnouncement', {
        count: selectedCount,
        entity: entityName,
      })
  ...
  return (
    <>
      ...
      <div
        ref={toolbarRef}
        role='toolbar'
        aria-label={t('dataTable.bulkActions.toolbarLabel', {
          count: selectedCount,
          entity: entityName,
        })}
        ...
        >
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                title={t('dataTable.bulkActions.clearSelectionWithShortcut')}
              >
                <X />
            ...
            <TooltipContent>
              <p>{t('dataTable.bulkActions.clearSelectionWithShortcut')}</p>
            </TooltipContent>
          </Tooltip>
          ...
          >
            <Badge
              ...
              aria-label={t('dataTable.selectedCount', { count: selectedCount })}
            >
              {selectedCount}
            </Badge>{' '}
            <span className='hidden sm:inline'>
              {entityName} {t('dataTable.bulkActions.selected')}
            </span>
          </div>
